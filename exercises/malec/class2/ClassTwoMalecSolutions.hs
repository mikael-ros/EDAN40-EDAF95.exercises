{-
    These are the solutions provided by Malec himself, these are not my work.
    I host them here solely as reference.

    P.S, Malec, if you come across this and disagree with this being up:
    just contact me, and I'll take this file down! :)
-}

-----------------------------------------------------------------------------

-- class2.hs
-- updated 23.11.2015, 16:35 JM
